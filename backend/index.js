...
// GET - Compter les observations
app.get('/api/observations/count', async (req, res) => {
    try {
        const count = await observationsCollection.countDocuments();
        console.log(`📊 COUNT: ${count} observations`);
...
app.listen(PORT, () => {
    ...
    console.log('  GET    /api/observations/count');
